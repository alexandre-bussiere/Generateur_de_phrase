//
// Created by bussi on 08/11/2022.
//
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
char* takeLineFromTxt(int indexLineToExtract,int argument){
    ...
    int i =0;
    FILE * dictionnaire = fopen ("C:\\Users\\bussi\\Desktop\\Generateur-de-phrase\\Dictionnaire\\dictionnaire_non_accentue.txt","r");//demander a jad comment on fait des path pas absolue
